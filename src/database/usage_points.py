...
class UsagePointsConfig:  # pylint: disable=R0902
    ...
    def __init__(self) -> None:
        ...
        self.consumption_price_flex_normal_hc: float = 0
        self.consumption_price_flex_normal_hp: float = 0
        self.consumption_price_flex_sobriete_hc: float = 0
...
class DatabaseUsagePoints:
    ...
    def set_data(self, usage_point_data):
        ...
        usage_point = UsagePoints(
            ...
            consumption_price_flex_normal_hp=usage_point_data.consumption_price_flex_normal_hp,
            consumption_price_flex_normal_hc=usage_point_data.consumption_price_flex_normal_hc,
            consumption_price_flex_sobriete_hp=usage_point_data.consumption_price_flex_sobriete_hp,
            consumption_price_flex_sobriete_hc=usage_point_data.consumption_price_flex_sobriete_hc,
            consumption_price_flex_bonus_hp=usage_point_data.consumption_price_flex_bonus_hp,
            consumption_price_flex_bonus_hc=usage_point_data.consumption_price_flex_bonus_hc,
            consumption_max_date=usage_point_data.consumption_max_date,
            consumption_detail_max_date=usage_point_data.consumption_detail_max_date,
